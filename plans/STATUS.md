...
| `external-integrations-sms-kakao-plan.md` | "External Integration Module" framework (generalize gws/classcard) + SMS via pluggable provider adapter (Aligo/Solapi) + KakaoTalk channel assistant (chatbot route, no business verification) | **Pending — designed/researched 2026-06-11** (3 owner decisions open: provider scope, SMS per-user-account model, Kakao chatbot scope) |
