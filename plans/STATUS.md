...
| `external-integrations-sms-kakao-plan.md` | "External Integration Module" framework (generalize gws/classcard) + Solapi SMS + self-built KakaoTalk chatbot (receive/track/summarize/reply, no Solapi, free) | **Pending — designed/researched 2026-06-11; decisions resolved** (Solapi-only SMS · assisted SMS setup · Kakao self-built & free, no business verification; proactive 알림톡 reseller-only, deferred). No owner gate — all waves can proceed |
