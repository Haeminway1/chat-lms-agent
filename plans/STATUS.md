...
| `external-integrations-sms-kakao-plan.md` | "External Integration Module" framework (generalize gws/classcard) + Solapi messaging (SMS now, Kakao 알림톡/친구톡 proactive) + KakaoTalk chatbot inbound (receive/track/summarize/respond) | **Pending — designed/researched 2026-06-11; decisions resolved** (Solapi-only · assisted SMS setup · full Kakao business path). One gate before C-proactive: teacher's 사업자등록번호. Wave A + Wave B (SMS) are gate-independent |
