...
OSS_REFERENCE_REGISTRY: Final[tuple[dict[str, JsonValue], ...]] = (
    {
        "id": "agents-md",
        ...
        "must_not_copy": (
            "Do not store private profile data or volatile runtime state in public "
            "AGENTS.md."
        ),
    ...
    },
    {
        ...
        "local_mapping": (
            "Use local offload ids, summaries, and exact original retrieval before "
            "any dependency adoption."
        ),
    ...
    },
    {
        ...
        "must_not_copy": (
            "Do not import OpenClaw/Hermes patches, Docker sidecars, gateways, or "
    ...
    },
    {
        ...
        "adoption_status": "reference-only",
        "local_mapping": (
            "Use verifier receipts and lazy discovery patterns over existing Chat LMS "
            "trace/audit/closeout surfaces."
        ),
        "must_not_copy": (
            "Do not add a second coding-agent runtime, write-capable MCP proxy, or "
            "process manager."
        ),
